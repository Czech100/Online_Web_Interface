...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\kushi\Desktop\fastapi-web-starter-main\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\kushi\Desktop\fastapi-web-starter-main\venv\Scripts\deactivate.nu'
